...
public class ExceptionsReview {
	...
	public static void main(String[] args) {
		...
		// throw new ClassCastException();   giving error in the console => unchecked exception
		
	//	throw new FileNotFoundException();   giving error now => checked exception
		...
		// statements   => these statements will not be read if the exception is caught at the above line
		}

...
public class ArrayListClass {
	...
	public static void main(String[] args) {
		...
		shoppingList.add("apple");  // index 0
		shoppingList.add("orange");  // index 1
		shoppingList.add("grapes");  // index 2
		...
		shoppingList.add(4, "Toyota Corolla");
		System.out.println(shoppingList);
		...
		// get(index number): returns the object/data of that index
   ...
   // set(index number, object): the given object will replace the object at the given index number
		...
		// equals(ArrayList): checks if the two ArrayLists are equal or not, returns boolean result.
			...
			if(goodguys.contains("Ibrohim") && badguys.contains("Ibrohim")) {
				System.out.println("Ibrohim is a good guy");
			}
